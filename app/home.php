                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                ...
                                <div class="d-grid gap-2 d-md-flex">
                                    ...
                                    <a href="https://api.whatsapp.com/send?phone=<?= $deskrip[7] ?>&text=Halo WDM, Saya mau booking paket wisata *<?= $row['judul'] ?>*." target="_blank" class="btn btn-blue px-4 flex-md-fill"><i class="fab fa-whatsapp"></i> Book</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp d-flex align-items-stretch" data-wow-delay="0.1s">
                    <div class="card rounded shadow w-100 border-0 h-100 text-start">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                <hr>
                                <a href="https://api.whatsapp.com/send?phone=<?= $deskrip[7] ?>&text=Halo WDM, Saya mau booking mobil *<?= $row['judul'] ?>*." target="_blank" class="d-block btn btn-blue px-4"><i class="fab fa-whatsapp"></i> Booking Sekarang</a>
                            </div>
                        </div>
                    </div>
                </div>
