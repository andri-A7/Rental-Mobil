                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp d-flex align-items-stretch" data-wow-delay="0.1s">
                    <div class="card rounded shadow w-100 border-0 h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                <hr>
                                <a href="https://api.whatsapp.com/send?phone=<?= $deskrip[7] ?>&text=Halo WDN, Saya mau booking mobil *<?= $row['judul'] ?>*." target="_blank" class="d-block btn btn-blue px-4"><i class="fab fa-whatsapp"></i> Booking Sekarang</a>
                            </div>
                        </div>
                    </div>
                </div>
